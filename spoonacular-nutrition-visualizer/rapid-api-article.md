...
![spoonacular food analysis](https://rawcdn.githack.com/ddsky/spoonacular-nutrition-visualizer-app/4f7854d41e3391eb0a760b572c4b8b399f4a0e24/spoonacular-image-analysis-small.gif)

## Set up

This demo will use [Vue.js](https://vuejs.org/v2/guide/), for uploading an image the [Vue File Agent](https://safrazik.com/vue-file-agent/), for some fun animations [AnimeJS](https://animejs.com/), and of course the [spoonacular nutrition API](https://rapidapi.com/spoonacular/api/recipe-food-nutrition/). Before you start, get a free API key on Rapid API and subscribe to the free tier of the API.

We will not use and SDKs but call the spoonacular API directly. If your app runs on another language than JavaScript get one of Rapid API's [SDKs](https://docs.rapidapi.com/docs/getting-started-with-rapidapi-sdks).

## Getting started

This is a single file application so all we need is an html file. Here's the template we can start with. I leave out some styles and fields for brevity, the complete file is at the end of this tutorial.
